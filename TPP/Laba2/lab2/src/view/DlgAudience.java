...
public class DlgAudience extends JDialog implements IDlg{
	...
	public DlgAudience() {
		...
		contentPanel.setLayout(null);
		{
			...
			textField_Corps.setBounds(10, 54, 115, 34);
		...
		textField_Number.setBounds(10, 10, 115, 34);
		...
		textField_Number.setColumns(10);
		{
			...
			textField_Floor.setBounds(147, 10, 115, 34);
		...
		}
		{
			...
			textField_area.setBounds(276, 10, 115, 34);
