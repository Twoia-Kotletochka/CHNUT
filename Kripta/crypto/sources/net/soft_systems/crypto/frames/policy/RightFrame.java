...
import net.soft_systems.integrator.EditableBean;
public class RightFrame extends CryptoEditFrame {
	public RightFrame(CryptoBean bean) { super(bean); }
	...
	protected void initPropertiesPanel() {
		...
		propertiesPanel.add(new JLabel("Описание:"), c);
		c = new GridBagConstraints();
		c.gridwidth = GridBagConstraints.REMAINDER;
		c.gridheight = 1;
		c.fill = GridBagConstraints.BOTH;
