...
public class EnterRightOperation extends OperationBean {
	private Bean object;
	private Bean subject;
	private RightBean right;
	public EnterRightOperation(RightBean right, Bean subject, Bean object) {
		this.object = object;
		this.subject = subject;
		this.right = right;
	}
	public EnterRightOperation() { }
	...
	public String getOperation() {
		return "enter " + right.getId() + " into M[" + subject.getId() + "," + object.getId() + "]";
	}
	...
	public void exec() {
		if (Run.infoSystem.isPolicyEnabled(HRUPolicy.class)) {
			...
			if (policy != null) { policy.addRight(getRight(), getSubject(), getObject()); }
		}
	}
}
