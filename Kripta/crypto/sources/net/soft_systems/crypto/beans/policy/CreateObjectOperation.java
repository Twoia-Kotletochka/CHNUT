...
public class CreateObjectOperation extends OperationBean {
	private Bean object;
	public CreateObjectOperation(Bean object) { this.object = object; }
	...
	public String getOperation() { return "create object " + object.getId(); }
	...
	public void exec() { ModelServerImpl.SERVER.createProcess(getObject()); }
}
