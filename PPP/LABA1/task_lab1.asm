...
Infinite_loop:		;нескінченний цикл
	...
	rcall long_delay1; викликаємо затримку приблизно на 2 с
	...
	rcall long_delay; викликаємо затримку приблизно на 1 с

	ldi temp, t2	;задаємо маску запалювання світлодіодів 
	st Z, temp		;видаємо маску на світлодіоди
	rcall long_delay1; викликаємо затримку приблизно на 2 с

	ldi temp, t1	;задаємо маску запалювання світлодіодів 
	st Z, temp		;видаємо маску на світлодіоди
