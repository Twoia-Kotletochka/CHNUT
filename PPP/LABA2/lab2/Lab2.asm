...
.def minus = r22 ;регістр, який зберігає константу, що віднімається від маски
...
Infinite_loop:	;нескінченний цикл
	...
	ldi minus, 0x11	;заносимо число 0х11, на яке буде зменшуватися початкове
	ldi counter1, 0x10	;ініціалізуємо значення лічильника алгоритму
	ldi plus, 0x11 ; заносимо число, на яке буде збільшуватися
Loop1:
	...
	sub dig, minus	; віднімаємо від початкового значення маски число 11h
...
Loop:
	ldi counter2, 0x10 	;ініціалізуємо значення лічильника алгоритму
Loop2:
	st X, dig0	;видаємо маску на ліву пару знакомісць індикатора
	st Y, dig	;видаємо маску на праву пару знакомісць індикатора
	ldi temp, 0x03	;вимикаємо всі точки і запалюємо всі знакомісця
