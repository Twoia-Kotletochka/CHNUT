...
import process.TickerForMultiplication;
...
private TickerForMultiplication ticker;
	public TickerForMultiplication getTicker() {
		if(ticker == null)
			ticker = new TickerForMultiplication( 1000,0.1,ui.getFinishTime());
	return ticker;
}
	...
	public void componentsToStartList(){
		...
		getDispatcher().addStartingActor(getTicker());
	}
